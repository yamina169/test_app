...
describe("ContactSection", () => {
    ...
    it("updates full name when user types", async () => {
        const user = userEvent.setup();
        render(<ContactSection />);

        await user.type(screen.getByRole("textbox", { name: /fields\.fullName/i }), "Sana");

        expect(setFieldMock).toHaveBeenCalled();
        expect(setFieldMock).toHaveBeenCalledWith("fullName", expect.stringContaining("S"));
    });
    ...
    it("updates email when user types", async () => {
        ...
        await user.type(screen.getByRole("textbox", { name: /fields\.email/i }), "test@mail.com");

        expect(setFieldMock).toHaveBeenCalledWith("email", expect.any(String));
    });
    ...
    it("updates subject when user types", async () => {
        ...
        await user.type(screen.getByRole("textbox", { name: /fields\.subject/i }), "Hello");

        expect(setFieldMock).toHaveBeenCalledWith("subject", expect.any(String));
    });
    ...
    it("updates message when user types", async () => {
        ...
        await user.type(screen.getByRole("textbox", { name: /fields\.message/i }), "My message");

        expect(setFieldMock).toHaveBeenCalledWith("message", expect.any(String));
    });
