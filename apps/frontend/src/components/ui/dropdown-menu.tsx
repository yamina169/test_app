  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        // WCAG 2.4.7: visible focus indicator is handled on items; content keeps clear boundaries and contrast
        className={cn(
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        // WCAG 2.4.7: clear focus state on menu items for keyboard users
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        // WCAG 2.4.7: focus state visible for keyboard users
        "focus:bg-accent focus:text-accent-foreground",
        "data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
